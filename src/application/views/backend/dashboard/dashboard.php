            ...
            <table class="table table-bordered table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <?php
                        if ($this->dashboard_stats->member_role($this->session->userdata['username']) == 0)
                           echo 'Administrator';
                        elseif ($this->dashboard_stats->member_role($this->session->userdata['username']) == 1)
                           echo 'Empoyee';
                        elseif ($this->dashboard_stats->member_role($this->session->userdata['username']) == 2)
                           echo 'Reseller';
                        else
                           echo 'Error';
                        ?>
               ...
               <tbody>
                  ...
                  <?php foreach ($upcoming_tours as $dashboard_upcoming): ?>
                     ...
                     <tr>
                        ...
                        <td>
                           <span class="icon-calendar" style="color:red;"></span>
                           <?php echo date('d/m/Y', strtotime($dashboard_upcoming->from_start_time)) ?>
                        </td>
                        <td>
                           <span class="icon-clock" style="color:red;"></span>
                           <?php echo date('H:i', strtotime($dashboard_upcoming->from_start_time)) ?>
                        </td>
